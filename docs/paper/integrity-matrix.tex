...
one model (pre-registered follow-up arms, reported in the limitations,
rerun two cells across further model configurations and a second
system-of-record engine), with ground
truth read directly from the persisted SQLite of
...
\paragraph{Single model family --- partially addressed.} All cells of
